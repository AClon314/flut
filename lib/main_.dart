...
import './common/routers/navigation.dart' deferred as navigation;
import './common/routers/popups.dart' deferred as popups;
import './common/routers/surfaces.dart' deferred as surfaces;
import './common/routers/theming.dart' deferred as theming;
...
final router = GoRouter(navigatorKey: rootNavigatorKey, routes: [
  ShellRoute(
    ...
    routes: [
      /// Settings
      GoRoute(path: '/', builder: (context, state) => const Settings()),
